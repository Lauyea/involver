...
namespace Involver.Data.Migrations
{
    ...
    [Migration("20220802081856_RedefineAchievementClusteredIndex")]
    partial class RedefineAchievementClusteredIndex
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Involver.Models.AchievementModel.Achievement", b =>
                {
            ...
            modelBuilder.Entity("Involver.Models.AchievementModel.ProfileAchievement", b =>
                {
            ...
            modelBuilder.Entity("Involver.Models.Agree", b =>
                {
                    ...
                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("AgreeID"), 1L, 1);
            ...
            modelBuilder.Entity("Involver.Models.ArticleModel.ArticleTag", b =>
                {
            ...
            modelBuilder.Entity("Involver.Models.ArticleModel.ArticleViewer", b =>
                {
                    b.Property<string>("ProfileID")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("Involver.Models.Involving", b =>
                {
                    ...
                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("InvolvingID"), 1L, 1);
            ...
            modelBuilder.Entity("Involver.Models.Missions", b =>
                {
                    ...
                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("MissionsID"), 1L, 1);
            ...
            modelBuilder.Entity("Involver.Models.Notification", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Involver.Models.NovelModel.BiddingOption", b =>
                {
                    ...
                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("BiddingOptionID"), 1L, 1);
            ...
            modelBuilder.Entity("Involver.Models.NovelModel.Dice", b =>
                {
                    ...
                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("DiceID"), 1L, 1);
            ...
            modelBuilder.Entity("Involver.Models.NovelModel.NormalOption", b =>
                {
                    ...
                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("NormalOptionID"), 1L, 1);
            ...
            modelBuilder.Entity("Involver.Models.NovelModel.NovelTag", b =>
                {
                    b.Property<int>("TagId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Involver.Models.NovelModel.NovelViewer", b =>
                {
                    b.Property<string>("ProfileID")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("Involver.Models.NovelModel.Voting", b =>
                {
                    ...
                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("VotingID"), 1L, 1);
            ...
            modelBuilder.Entity("Involver.Models.StatisticalData.Payment", b =>
                {
            ...
            modelBuilder.Entity("Involver.Models.StatisticalData.ProfitSharing", b =>
                {
                    b.Property<int>("ProfitSharingID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("ProfitSharingID"), 1L, 1);
            ...
            modelBuilder.Entity("Involver.Models.ViewIp", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ArticleArticleTag", b =>
                {
                    b.HasOne("Involver.Models.ArticleModel.ArticleTag", null)
                        .WithMany()
                        .HasForeignKey("ArticleTagsTagId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Involver.Models.ArticleModel.Article", null)
                        .WithMany()
            ...
            modelBuilder.Entity("ArticleViewIp", b =>
                {
                    ...
                    b.HasOne("Involver.Models.ViewIp", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Involver.Models.AchievementModel.ProfileAchievement", b =>
                {
                    b.HasOne("Involver.Models.AchievementModel.Achievement", "Achievement")
            ...
            modelBuilder.Entity("NovelNovelTag", b =>
                {
                    b.HasOne("Involver.Models.NovelModel.NovelTag", null)
                        .WithMany()
                        .HasForeignKey("NovelTagsTagId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Involver.Models.NovelModel.Novel", null)
                        .WithMany()
